  ...
  return (
    ...
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form className='flex flex-col'>
        ...
        <input type="text" id='email' placeholder='email' className='border p-3 rounded-lg mt-3' />
        <input type="text" id='password' placeholder='password' className='border p-3 rounded-lg mt-3' />
        <button className='bg-slate-700 text-white rounded-lg p-3 uppercase hover:opacity-95 mt-3'>Update</button>
      </form>
